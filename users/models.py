...
class User(AbstractBaseUser, PermissionsMixin, TimeStampedModel):
    ...
    login_type = (("KakaoLogin", "KakaoLogin"), ("SiteLogin", "SiteLogin"))
    ...
    profile_image_url = models.CharField(
        "profile_image_url", max_length=200, null=True, blank=True
    )
    profile_image_storage_path = models.CharField(
        "profile_image_storage_path", max_length=200, null=True, blank=True
    )
