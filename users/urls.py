...
from .views import (
    ...
    KaKaoLogOutView,
    RunSMSAuthView,
    MatchEmailAndContactNumView,
    GetEmailByContactNumView,
    SetNewPWView,
    SiteSignUpView,
    CheckSMSAuthView,
    SiteLoginView,
...
urlpatterns = [
    ...
    path(
        "matchemailandcontactnum",
        MatchEmailAndContactNumView.as_view(),
        name="matchemailandcontactnum",
    ),
    path(
        "getemailbycontactnumview",
        GetEmailByContactNumView.as_view(),
        name="getemailbycontactnumview",
    ),
    path("setnewpw", SetNewPWView.as_view(), name="setnewpw"),
    path("sitesignup", SiteSignUpView.as_view(), name="sitesignup"),
    path("sitelogin", SiteLoginView.as_view(), name="sitelogin"),
]
