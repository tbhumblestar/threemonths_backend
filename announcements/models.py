...
class QnAComment(TimeStampedModel):
    ...
    qna = models.ForeignKey(
        "QnA", on_delete=models.CASCADE, related_name="qna_comments"
    )
    content = models.TextField()
...
class Notice(TimeStampedModel):
    ...
    title = models.TextField()
    content = models.TextField()
    img1_url = models.CharField(max_length=500, null=True)
    img1_s3_path = models.CharField(max_length=500, null=True)
